...
<template>
  <div class="top">
    <span class="top-content">HUST-MALL</span>
    <van-icon class="top-icon" name="weapp-nav" />
  </div>
  <div class="container">
    <div class="search">
            <van-search
    ...
    <div class="main">
      <Plate class="section-header" title="闲置物品列表" />
      <!-- <van-grid :column-num="3">
        <van-grid-item v-for="value in 6" :key="value" icon="photo-o" text="文字" />
      </van-grid> -->
      <!-- 商品分类 -->
      <van-tabs v-model:active="categoryIndex" animated    @click-tab="onCategoryChange">
        ...
        <div v-for="item in list" :key="item.id" class="list-col">
          <div class="list-item" @click="onGoodClicked(item.id)">
            ...
            <div class="list-item-info">
              ...
              <van-tag type="primary"  plain>可刀 </van-tag>
              <van-tag type="primary"  plain>自取 </van-tag>
              <div class="list-item-price">
                ...
                <van-button type="primary" plain class="buy-btn">我想要</van-button>
              </div>
            </div>
          </div>
        </div>
